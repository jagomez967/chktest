    ...
    $.fn.circliful = function (options, callback) {
        ...
        return this.each(function () {
            ...
            if ($(this).data('info') != undefined) {
                ...
                if (info.charAt(0)=='-') {
                    //icon = 'triangle_down.png';
                    icon = 'red';
                }
                else
                {
                    //icon = 'triangle_up.png';
                    icon = '#03d800';
                }
                ...
                if ($(this).data('type') != undefined) {
                    ...
                    if (type == 'half') {
                        addInfoText(obj, 0.9,icon);
                    } else {
                        addInfoText(obj, 1.25,icon);
                    }
                } else {
                    addInfoText(obj, 1.25,icon);
                }
             ...
             * @param factor
             */
            function addInfoText(obj, factor, icon) {
                var sp = $('<span></span>')
                    .appendTo(obj)
                    ...
                    .text(info);
                if (icon != null && icon !== '')
                    //$('<img></img>').appendTo(sp).attr('src', './images/'+icon).addClass('circle-info-icon').css('width', '10px').css('height', '10px');
                    sp.css('color', icon);
