IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.ASUS_VentasProducto_T1'))
   exec('CREATE PROCEDURE [dbo].[ASUS_VentasProducto_T1] AS BEGIN SET NOCOUNT ON; END')
Go
alter procedure [dbo].[ASUS_VentasProducto_T1] 	
(
	@IdCliente			int
