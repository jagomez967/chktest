IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Cob_Mensual_T5'))
   exec('CREATE PROCEDURE [dbo].[Cob_Mensual_T5] AS BEGIN SET NOCOUNT ON; END')
Go
alter procedure [dbo].[Cob_Mensual_T5] 	
(
	@IdCliente			int
