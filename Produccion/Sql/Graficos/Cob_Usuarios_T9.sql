IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Cob_Usuarios_T9'))
   exec('CREATE PROCEDURE [dbo].[Cob_Usuarios_T9] AS BEGIN SET NOCOUNT ON; END')
GO
alter procedure [dbo].[Cob_Usuarios_T9]
(
	@IdCliente			int
...
*/		
	...
	begin
		...
		inner join usuario u on u.idUsuario = pcu.idUsuario
