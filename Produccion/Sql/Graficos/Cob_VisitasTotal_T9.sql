IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Cob_VisitasTotal_T9'))
   exec('CREATE PROCEDURE [dbo].[Cob_VisitasTotal_T9] AS BEGIN SET NOCOUNT ON; END')
GO
alter procedure [dbo].[Cob_VisitasTotal_T9]
(
	@IdCliente			int
...
*/		
	...
	insert #datos
	select	convert(varchar, r.FechaCreacion, 120),
