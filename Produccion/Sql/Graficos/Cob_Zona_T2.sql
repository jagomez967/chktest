IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Cob_Zona_T2'))
   exec('CREATE PROCEDURE [dbo].[Cob_Zona_T2] AS BEGIN SET NOCOUNT ON; END')
GO 
alter PROCEDURE [dbo].[Cob_Zona_T2] 	
(
	@IdCliente			int
