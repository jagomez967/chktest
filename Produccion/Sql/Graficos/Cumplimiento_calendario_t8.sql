IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Cumplimiento_Calendario_T8'))
   exec('CREATE PROCEDURE [dbo].[Cumplimiento_Calendario_T8] AS BEGIN SET NOCOUNT ON; END')
GO
alter procedure [dbo].[Cumplimiento_Calendario_T8] 	
(
	@IdCliente			int
