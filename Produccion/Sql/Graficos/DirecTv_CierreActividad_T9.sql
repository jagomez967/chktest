IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.DirecTv_CierreActividad_T9'))
   exec('CREATE PROCEDURE [dbo].[DirecTv_CierreActividad_T9] AS BEGIN SET NOCOUNT ON; END')
GO
alter procedure dbo.DirecTv_CierreActividad_T9
(
	@IdCliente			int
...
*/		
	...
	select @maxpag
		...
		from MD_Item i
		where IdModulo=91 and Activo=1
	...
	--exec DirecTv_Actividades_T9 11, 'M,00010101,00010101',null,null,null,null,null,null,null,1,null,'modDatos'
end