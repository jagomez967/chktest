IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.DirecTv_EstadoPDV_T9'))
   exec('CREATE PROCEDURE [dbo].[DirecTv_EstadoPDV_T9] AS BEGIN SET NOCOUNT ON; END')
GO
alter procedure dbo.DirecTv_EstadoPDV_T9
(
	@IdCliente			int
...
*/		
	...
	select @maxpag
		...
		from MD_Item i
		where IdModulo=96 and Activo=1
