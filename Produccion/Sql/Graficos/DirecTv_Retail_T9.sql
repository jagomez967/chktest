IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.DirecTv_Retail_T9'))
   exec('CREATE PROCEDURE [dbo].[DirecTv_Retail_T9] AS BEGIN SET NOCOUNT ON; END')
GO
alter procedure dbo.DirecTv_Retail_T9
(
	@IdCliente			int
...
*/		
	...
	select @maxpag
		...
		from MD_Item i
		where IdModulo=98 and Activo=1
	...
	--exec DirecTv_Retail_T9 9, 'M,00010101,00010101',null,null,null,null,null,null,null,-1,null,'modDatos'
end