IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.EPSONShaIC_T11'))
   exec('CREATE PROCEDURE [dbo].[EPSONShaIC_T11] AS BEGIN SET NOCOUNT ON; END')
GO
alter procedure [dbo].[EPSONShaIC_T11] 	
(
	@IdCliente			int
...
*/		
	...
	declare @marcaGrafico int = 2991 -- IC
