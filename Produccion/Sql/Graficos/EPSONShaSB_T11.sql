IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.EPSONShaSB_T11'))
   exec('CREATE PROCEDURE [dbo].[EPSONShaSB_T11] AS BEGIN SET NOCOUNT ON; END')
GO
alter procedure [dbo].[EPSONShaSB_T11] 	
(
	@IdCliente			int
...
*/		
	...
	declare @marcaGrafico int = 2993 -- SB
