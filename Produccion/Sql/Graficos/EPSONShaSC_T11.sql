IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.EPSONShaSC_T11'))
   exec('CREATE PROCEDURE [dbo].[EPSONShaSC_T11] AS BEGIN SET NOCOUNT ON; END')
GO
alter procedure [dbo].[EPSONShaSC_T11] 	
(
	@IdCliente			int
...
*/		
	...
	declare @marcaGrafico int = 2994 -- SC
