IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Edding_Cob_Mensual_T1'))
   exec('CREATE PROCEDURE [dbo].[Edding_Cob_Mensual_T1] AS BEGIN SET NOCOUNT ON; END')
Go--[edding_Cob_Mensual_T1] 127  --438--27//422--38 (384/11)

alter procedure [dbo].[Edding_Cob_Mensual_T1] 	
(
	@IdCliente			int
