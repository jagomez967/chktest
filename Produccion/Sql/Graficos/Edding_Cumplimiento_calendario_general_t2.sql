IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Edding_Cumplimiento_Calendario_General_T2'))
   exec('CREATE PROCEDURE [dbo].[Edding_Cumplimiento_Calendario_General_T2] AS BEGIN SET NOCOUNT ON; END')
GO 
alter procedure [dbo].[Edding_Cumplimiento_Calendario_General_T2] 	
(
	@IdCliente			int
