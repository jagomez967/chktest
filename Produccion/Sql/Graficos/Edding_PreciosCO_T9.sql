IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Edding_PreciosCO_T9'))
   exec('CREATE PROCEDURE [dbo].[Edding_PreciosCO_T9] AS BEGIN SET NOCOUNT ON; END')
GO
alter procedure [dbo].[Edding_PreciosCO_T9]
(
	@IdCliente			int
