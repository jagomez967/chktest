IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.ElectroLux_EvolucionPrecio_PropioCompetencia_T22'))
   exec('CREATE PROCEDURE [dbo].[ElectroLux_EvolucionPrecio_PropioCompetencia_T22] AS BEGIN SET NOCOUNT ON; END')
Go
alter procedure [dbo].[ElectroLux_EvolucionPrecio_PropioCompetencia_T22]
(
	@IdCliente			int
...
exec ElectroLux_EvolucionPrecio_PropioCompetencia_T22 @IdCliente=235,@Filtros=@p2,@NumeroDePagina=-1,@Lenguaje='es'
...
exec ElectroLux_EvolucionPrecio_PropioCompetencia_T22 @IdCliente=235,@Filtros=@p3,@NumeroDePagina=-1,@Lenguaje='es'
*/
