IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.ElectroLux_Floor_Space_T3'))
   exec('CREATE PROCEDURE [dbo].[ElectroLux_Floor_Space_T3] AS BEGIN SET NOCOUNT ON; END')
Go
alter procedure [dbo].[ElectroLux_Floor_Space_T3]
(
	@IdCliente			int
