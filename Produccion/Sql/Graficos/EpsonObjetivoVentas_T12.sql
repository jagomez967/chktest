IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.EpsonObjetivoVentas_T12'))
   exec('CREATE PROCEDURE [dbo].[EpsonObjetivoVentas_T12] AS BEGIN SET NOCOUNT ON; END')
GO
ALTER procedure [dbo].[EpsonObjetivoVentas_T12]
(
	@IdCliente			int
