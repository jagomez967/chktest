--Epson_EvaluacionPorItem_T1 61
IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Epson_EvaluacionPorItem_T1'))
   exec('CREATE PROCEDURE [dbo].[Epson_EvaluacionPorItem_T1] AS BEGIN SET NOCOUNT ON; END')
GO
alter procedure [dbo].[Epson_EvaluacionPorItem_T1] 	
(
	@IdCliente			int
...
select* From usuario where idUsuario in(57,309)