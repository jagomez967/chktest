IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Epson_RetailAccuracy_T27'))
   exec('CREATE PROCEDURE [dbo].[Epson_RetailAccuracy_T27] AS BEGIN SET NOCOUNT ON; END')
GO
ALTER PROCEDURE [dbo].[Epson_RetailAccuracy_T27]
(
	@IdCliente			INT,
...
BEGIN
	...
	*/		
	...
	SELECT
		'Retail Sell-In Accuracy' SerieName, 
