IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Epson_SellOutICMoM_T28'))
   exec('CREATE PROCEDURE [dbo].[Epson_SellOutICMoM_T28] AS BEGIN SET NOCOUNT ON; END')
GO
ALTER PROCEDURE [dbo].[Epson_SellOutICMoM_T28]
(
	@IdCliente			INT,
