IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Epson_UnidadesPSI_T27'))
   exec('CREATE PROCEDURE [dbo].[Epson_UnidadesPSI_T27] AS BEGIN SET NOCOUNT ON; END')
GO
ALTER PROCEDURE [dbo].[Epson_UnidadesPSI_T27]
(
	@IdCliente			INT,
