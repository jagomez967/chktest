IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Epson_VarSellInSellOutRet_T30'))
   exec('CREATE PROCEDURE [dbo].[Epson_VarSellInSellOutRet_T30] AS BEGIN SET NOCOUNT ON; END')
GO
ALTER PROCEDURE [dbo].[Epson_VarSellInSellOutRet_T30]
(
	@IdCliente			INT,
