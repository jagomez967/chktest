IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Fac_RepProdCompetencia_T9'))
   exec('CREATE PROCEDURE [dbo].[Fac_RepProdCompetencia_T9] AS BEGIN SET NOCOUNT ON; END')
GO
alter procedure [dbo].[Fac_RepProdCompetencia_T9]
(
	@IdCliente			int
...
*/		
	...
	insert #datosFinal (idReporte,idPuntoDeVenta,fechaCreacion, PuntoDeVenta,TipoPDV, Direccion, Usuario, Zona, Provincia, Cadena, idMarca, Marca, Empresa, idProducto, Producto, Familia, Precio, Frentes1, Exhibidor1, Frentes2, Exhibidor2)
	select	r.idReporte,
			pdv.IdPuntoDeVenta,
			rep.FechaCreacion,
	...
	if(@lenguaje = 'es')
		insert #columnasConfiguracion (name, title, width) values ('idReporte','idReporte',5),('idPuntoDeVenta','idPuntoDeVenta',5),('fechaCreacion','Fecha Reporte',5),('PuntoDeVenta','PuntoDeVenta',5),('TipoPDV','TipoPDV',5),('Direccion','Direccion',5),('Usuario','RTM',5),('Zona','Zona',5),('Provincia','Provincia',5),('Cadena','Cadena',5),('Marca','Marca',5),('Empresa','CategoriaCompetencia',5),('Producto','Producto',5),('Familia','Familia',5),('Precio','Precio',5),('Frentes1','Frentes 1',5),('Exhibidor1','Exhibidor 1',5),('Frentes2','Frentes 2',5),('Exhibidor2','Exhibidor 2',10)

	if(@lenguaje = 'en')
		insert #columnasConfiguracion (name, title, width) values ('idReporte','idReporte',5),('idPuntoDeVenta','idPDV',5),('fechaCreacion','Fecha Reporte',5),('PuntoDeVenta','PDV',5),('TipoPDV','TipoPDV',5),('Direccion','Address',5),('Usuario','RTM',5),('Zona','Zone',5),('Provincia','Province',5),('Cadena','Retail',5),('Marca','Category',5),('Empresa','Brand',5),('Producto','Product',5),('Familia','Family',5),('Precio','Price',5),('Frentes1','Qty 1',5),('Exhibidor1','Exhibition 1',5),('Frentes2','Qty 2',5),('Exhibidor2','Exhibition 2',10)

	select name, title, width from #columnasConfiguracion

	--Datos
	if(@NumeroDePagina>0)
		select idReporte,idPuntoDeVenta,fechaCreacion, PuntoDeVenta,TipoPDV, Direccion, Usuario, Zona, Provincia, Cadena, Marca, Empresa, Producto, Familia, Precio, Frentes1, Exhibidor1, Frentes2, Exhibidor2 from #datosFinal where id between ((@NumeroDePagina - 1) * @TamañoPagina + 1) and (@NumeroDePagina * @TamañoPagina)
	
	if(@NumeroDePagina=0)
		select idReporte,idPuntoDeVenta,fechaCreacion, PuntoDeVenta, TipoPDV,Direccion, Usuario, Zona, Provincia, Cadena, Marca, Empresa, Producto, Familia, Precio, Frentes1, Exhibidor1, Frentes2, Exhibidor2 from #datosFinal where id between ((@maxpag - 1) * @TamañoPagina + 1) and (@maxpag * @TamañoPagina)
		
	if(@NumeroDePagina<0)
		select idReporte,idPuntoDeVenta,fechaCreacion, PuntoDeVenta,TipoPDV, Direccion, Usuario, Zona, Provincia, Cadena, Marca, Empresa, Producto, Familia, Precio, Frentes1, Exhibidor1, Frentes2, Exhibidor2 from #datosFinal
