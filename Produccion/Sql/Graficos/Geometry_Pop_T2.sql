IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Geometry_Pop_T2'))
   exec('CREATE PROCEDURE [dbo].[Geometry_Pop_T2] AS BEGIN SET NOCOUNT ON; END')
GO
ALTER procedure [dbo].Geometry_Pop_T2
(
	@IdCliente			int
