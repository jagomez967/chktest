IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.IsdinDiaUsuario_T7'))
   exec('CREATE PROCEDURE [dbo].[IsdinDiaUsuario_T7] AS BEGIN SET NOCOUNT ON; END')
Go
alter procedure [dbo].[IsdinDiaUsuario_T7]
(
	@IdCliente			int
...
*/		
	...
	--2 ResultSet = 'DIA','FormatoDIA','idUsuario','NombreUsuario','COBERTURA/OBJETIVO','Valor'
		select b.fecha as dia,
			   convert(varchar(10),b.fecha,103) as dia2,
			   b.idUsuario,
		...
		group by b.fecha,b.idUsuario,u.apellido + ', ' + u.nombre collate database_default
	union
		select b.fecha as dia,
			   convert(varchar(10),b.fecha,103) as dia2,
			   b.idUsuario,
	...
	select b.fecha  as dia,
		...
		from #baseContactos b
		inner join usuario u on u.idUsuario = b.idUsuario
		group by b.fecha,b.idUsuario,b.idModulo,b.nombreModulo,u.apellido + ', ' + u.nombre collate database_default
	order by 1 asc
...
isdinDiaUsuario_t7 175
go




--contactos	idUsuario	dia	idCliente	idPuntodeventa
--6	2792	2018-04-03	159	113985
--6	2792	2018-04-06	159	113988
--6	2792	2018-04-09	159	114030

--idCliente	idUsuario	IdReporte	IdPuntodeventa	dia
--159	2792	603038	113985	2018-04-03
--159	2792	605431	113988	2018-04-06
--159	2792	606404	114030	2018-04-09
