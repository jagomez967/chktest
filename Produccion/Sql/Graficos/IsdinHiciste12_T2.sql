IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.IsdinHiciste12_t2'))
   exec('CREATE PROCEDURE [dbo].[IsdinHiciste12_T2] AS BEGIN SET NOCOUNT ON; END')
Go
alter procedure [dbo].[IsdinHiciste12_T2]
(
	@IdCliente			int
