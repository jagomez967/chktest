IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Isdin_LAM_ReporteMaterial_T20'))
   EXEC('CREATE PROCEDURE [dbo].[Isdin_LAM_ReporteMaterial_T20] AS BEGIN SET NOCOUNT ON; END')
GO
ALTER PROCEDURE [dbo].[Isdin_LAM_ReporteMaterial_T20]
(
	@IdCliente			INT,
...
*/		
	...
	WHERE 
		M.idModulo IN (
						2174, -- LAM IMPULSO
						2093,2291, -- LAM VISITA FARMACIA
						2367,2368  -- LAM ASESORA
						)
