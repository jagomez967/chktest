IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Isdin_LAM_ReporteTester_T20'))
   EXEC('CREATE PROCEDURE [dbo].[Isdin_LAM_ReporteTester_T20] AS BEGIN SET NOCOUNT ON; END')
GO
ALTER PROCEDURE [dbo].[Isdin_LAM_ReporteTester_T20]
(
	@IdCliente			INT,
