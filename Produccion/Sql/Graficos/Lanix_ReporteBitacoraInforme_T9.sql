IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Lanix_ReporteBitacoraInforme_T9'))
   exec('CREATE PROCEDURE [dbo].[Lanix_ReporteBitacoraInforme_T9] AS BEGIN SET NOCOUNT ON; END')
GO
alter procedure [dbo].Lanix_ReporteBitacoraInforme_T9
(
	@IdCliente			int
