IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Loreal_ExhibicionAdicional_T10'))
   exec('CREATE PROCEDURE [dbo].[Loreal_ExhibicionAdicional_T10] AS BEGIN SET NOCOUNT ON; END')
GO
alter procedure [dbo].[Loreal_ExhibicionAdicional_T10] 	
(
	@IdCliente			int
