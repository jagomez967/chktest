IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Met_QuiebreMarcas_T1'))
   exec('CREATE PROCEDURE [dbo].[Met_QuiebreMarcas_T1] AS BEGIN SET NOCOUNT ON; END')
GO
alter procedure [dbo].[Met_QuiebreMarcas_T1] 	
(
	@IdCliente			int
