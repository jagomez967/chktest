IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Neopop_iseScore_T1'))
   exec('CREATE PROCEDURE [dbo].[Neopop_iseScore_T1] AS BEGIN SET NOCOUNT ON; END')
GO
alter procedure Neopop_iseScore_T1
(
	@IdCliente			int
...
*/		
	...
	--exec Neopop_iseScore_T1 1, 'M,20160505,20160505', null, null, null, null, null, null, '380'
end