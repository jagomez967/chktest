...
*/		
	...
	--Datos
	if(@NumeroDePagina>0)
		select marca, cast(driverA as varchar) + ' %' as driverA, cast(driverB as varchar) + ' %' as driverB, cast(driverC as varchar) + ' %' as driverC, cast(iseScore as varchar) + ' %' as iseScore from #datosFinal where id between ((@NumeroDePagina - 1) * @TamañoPagina + 1) and (@NumeroDePagina * @TamañoPagina)
	
	if(@NumeroDePagina=0)
		select marca, cast(driverA as varchar) + ' %' as driverA, cast(driverB as varchar) + ' %' as driverB, cast(driverC as varchar) + ' %' as driverC, cast(iseScore as varchar) + ' %' as iseScore from #datosFinal where id between ((@maxpag - 1) * @TamañoPagina + 1) and (@maxpag * @TamañoPagina)
