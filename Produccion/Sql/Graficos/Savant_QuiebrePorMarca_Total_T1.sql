IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Savant_QuiebrePorMarca_Total_T1'))
   EXEC('CREATE PROCEDURE [dbo].[Savant_QuiebrePorMarca_Total_T1] AS BEGIN SET NOCOUNT ON; END')
GO
ALTER PROCEDURE [dbo].[Savant_QuiebrePorMarca_Total_T1]
(
	@IdCliente			INT,
