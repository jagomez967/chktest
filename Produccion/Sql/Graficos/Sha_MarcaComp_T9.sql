IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Sha_MarcaComp_T9'))
   exec('CREATE PROCEDURE [dbo].[Sha_MarcaComp_T9] AS BEGIN SET NOCOUNT ON; END')
GO
alter procedure [dbo].[Sha_MarcaComp_T9] 	
(
	@IdCliente			int
...
*/		
	...
	select r.idEmpresa, p.idMarca, SUM(isnull(rp.Cantidad,0)+isnull(rp.Cantidad2,0))
