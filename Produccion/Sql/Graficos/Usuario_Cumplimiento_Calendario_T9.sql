IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.Usuario_Cumplimiento_Calendario_T9'))
   exec('CREATE PROCEDURE [dbo].[Usuario_Cumplimiento_Calendario_T9] AS BEGIN SET NOCOUNT ON; END')
GO
alter procedure [dbo].[Usuario_Cumplimiento_Calendario_T9]
(
	@IdCliente			int
...
--insert into @p2 values(N'fltFechaReporte',N'M,20181101,20190104')
...
--exec Usuario_Cumplimiento_Calendario_T9 @IdCliente=49,@Filtros=@p2,@NumeroDePagina=-1,@Lenguaje='es'
