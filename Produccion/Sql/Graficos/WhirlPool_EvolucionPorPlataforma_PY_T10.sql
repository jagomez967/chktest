IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.WhirlPool_EvolucionPorPlataforma_PY_T10'))
   exec('CREATE PROCEDURE [dbo].[WhirlPool_EvolucionPorPlataforma_PY_T10] AS BEGIN SET NOCOUNT ON; END')
GO
ALTER PROCEDURE [dbo].WhirlPool_EvolucionPorPlataforma_PY_T10
(
	@IdCliente			INT
...
---
---exec WhirlPool_EvolucionPorPlataforma_PY_T10 @IdCliente=190,@Filtros=@p2,@NumeroDePagina=-1,@Lenguaje='es'