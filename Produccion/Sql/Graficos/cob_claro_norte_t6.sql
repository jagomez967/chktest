IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND OBJECT_ID = OBJECT_ID('dbo.cob_claro_norte_T6'))
   exec('CREATE PROCEDURE [dbo].[cob_claro_norte_T6] AS BEGIN SET NOCOUNT ON; END')
GO
alter procedure [dbo].[cob_claro_norte_T6] 	
(
	@IdCliente			int
